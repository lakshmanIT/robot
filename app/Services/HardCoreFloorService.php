...
/*
|--------------------------------------------------------------------------
| Hard Core Floor Service Class
|--------------------------------------------------------------------------
|
| Here is all the hard core floor apartments robot cleaning functionality executed here
|
*/
class HardCoreFloorService implements FloorInterface
{
    public $area; 

    /**
     * Here Robot initially to start clean the Hard core floor apartment.
     *
     * @param  $area;
     * @return $response
     */
    ...
    {
        $time = Config::get('constants.ROBOT_LIFE_ONCE_CHARGE')/Config::get('constants.ROBOT_CLEAN_TIME_1M_HARD');
        return $time;
    }
